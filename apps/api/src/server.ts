...
export async function createServer() {
  ...
  await app.register(fastifyHelmet, { contentSecurityPolicy: process.env['NODE_ENV'] === 'production' })
  ...
  await app.register(fastifyRateLimit, { max: 200, timeWindow: '1 minute', redis, skipOnError: false })
