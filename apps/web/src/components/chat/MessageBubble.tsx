...
export function MessageBubble({ message, isOwn, onReact, onEdit, onDelete }: Props) {
      ...
      <div className={`flex flex-col max-w-[70%] ${isOwn ? 'items-end' : 'items-start'}`}>
        ...
        <div className="relative">
          <div className={`px-4 py-2.5 rounded-2xl text-sm leading-relaxed ${
            ...
            {/* Encrypted badge — in Phase 2 client-side decryption replaces this */}
            <p className="whitespace-pre-wrap break-words">{message.bodyEncrypted}</p>
